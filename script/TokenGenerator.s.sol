...
contract TokenGenerator is Script {
    function run() external {
        ...
        address[] memory wallets = new address[](20);
        ...
        wallets[19] = 0x4F0DB4e3E43608d09Fd9c9E63E47dfa25bfF80fC;


        vm.startBroadcast();

        // Deploy the mintable ERC20 token
        MyMintableERC20 token = new MyMintableERC20("Test Lothery", "TLTR", msg.sender);
        console2.log("MyMintableERC20 deployed at:", address(token));

        uint256 amountToMint = 1_000_000_000 * 10 ** 18; // 1 Billion tokens with 18 decimals
